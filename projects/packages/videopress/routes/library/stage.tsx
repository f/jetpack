...
const StageInner = () => {
	...
	// The factory owns the in-flight set (re-entry guard + overlay snapshots)
	// and reacts via the mutateAsync promise; see promote-local.ts for why.
	const promoteLocal = useMemo(
		() =>
			createPromoteLocal( {
				...
				createSuccessNotice,
				createErrorNotice,
				onPromotingChange: setPromotingIds,
			} ),
