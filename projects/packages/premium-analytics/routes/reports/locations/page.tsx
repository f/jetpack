			...
			breadcrumbs={
				<Breadcrumbs
					items={ [
						...
						{ label: __( 'Locations', 'jetpack-premium-analytics' ) },
					] }
				/>
			}
			subTitle={ __( 'See where your visitors are viewing from.', 'jetpack-premium-analytics' ) }
			...
			<div className={ styles.content }>
				...
				>
					...
					<ReportRecordsTable< LocationRow >
						...
						searchLabel={ __( 'Search locations', 'jetpack-premium-analytics' ) }
					/>
				</ReportPageLayout>
			</div>
		</Page>
